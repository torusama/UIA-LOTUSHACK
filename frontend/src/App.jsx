...
const css = `
  ...
  .page-shell { background:rgba(255,255,255,0.72); backdrop-filter:blur(18px); -webkit-backdrop-filter:blur(18px); border-radius:20px; padding:28px; box-shadow:0 4px 24px rgba(99,102,241,0.08); border:1px solid rgba(255,255,255,0.8); }
...
export default function App() {
  const [screen, setScreen] = useState("landing"); // "landing" | "auth" | "app" | "profile"
